  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="mb-8">
        <Text
          variant="body"
          className="font-medium text-foreground mb-3 flex items-center"
        >
          <svg
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Text variant="small" className="text-xs text-muted mb-1">
              Mínimo
            </Text>
            <input
              type="number"
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3 mt-3">
            {sizes.map((size) => {
              ...
              let buttonStyle =
                "w-12 h-12 flex items-center justify-center rounded-lg border-2 font-medium transition-all duration-200 transform hover:scale-105";
              if (isSelected) {
              ...
              return (
                ...
                >
                  <span className={textStyle}>{size.label}</span>
                </button>
              );
            })}
          </div>
