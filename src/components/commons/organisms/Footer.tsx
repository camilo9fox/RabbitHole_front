...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-primary dark:bg-primary/95 text-foreground"
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-secondary/80 text-sm">
                Recibe las últimas novedades, diseños exclusivos y ofertas
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <Logo size={40} showText={true} textClassName="text-foreground" />
            <p className="text-sm text-muted">
              Crea diseños personalizados y únicos para tus poleras. Tu
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/shop"
                  className="text-secondary/80 hover:text-accent flex items-center group transition-colors duration-200"
                >
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Rabbit Hole. Todos los derechos
              reservados.
            </p>
