...
import ProductCatalog, {
  Product,
} from "@/components/commons/organisms/ProductCatalog";
...
const adminProductToShopFormat = (adminProduct: ProductOnGetDTO): Product => {
  return {
    ...
    price: adminProduct.disenoPersonalizado.precio,
    image: "",
    category: adminProduct.categoriaNombre,
    color: adminProduct.disenoPersonalizado.colorId ?? "white",
  };
};
...
export default function Shop() {
  ...
  const loadProducts = useCallback(async () => {
    ...
    try {
      ...
      const adminProducts = await fetchProducts("activos=true");

      // Convertir productos de administrador a formato de tienda
      const shopProducts = adminProducts.map(adminProductToShopFormat);
      ...
      const uniqueCategories = [
        ...new Set(adminProducts.map((p) => p.categoriaNombre)),
      ]
        ...
        {!isLoading && products.length === 0 && (
          <div className="flex flex-col justify-center items-center min-h-[400px] text-center">
            ...
            <p className="text-muted">
              Actualmente no hay productos publicados en la tienda.
            </p>
          </div>
        )}
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/4">
              ...
              >
                ...
                {/* Banner promocional */}
                <div
                  className={`mt-8 p-6 rounded-xl overflow-hidden relative ${
            ...
            <div className="lg:w-3/4">
              ...
              >
                <div className="flex flex-col items-center text-center p-6">
                  ...
                  <p className="text-sm">
                    Utilizamos solo algodón de alta calidad para garantizar
                ...
                <div className="flex flex-col items-center text-center p-6">
                  ...
                  <p className="text-sm">
                    Técnicas de impresión avanzadas que garantizan que tus
                    diseños permanezcan intactos.
                  </p>
                </div>
                ...
                <div className="flex flex-col items-center text-center p-6">
                  ...
                  <p className="text-sm">
                    Entrega en 2-5 días hábiles. Seguimiento en tiempo real para
                    todos tus pedidos.
                  </p>
                </div>
              </div>
